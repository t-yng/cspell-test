...
export declare function suggest(root: TrieRoot | TrieRoot[], word: string, maxNumSuggestions?: number, compoundMethod?: CompoundWordsMethod, numChanges?: number, ignoreCase?: boolean): SuggestionResult[];
...
export declare function suggestionCollector(wordToMatch: string, maxNumSuggestions: number, filter?: (word: string, cost: number) => boolean, changeLimit?: number, includeTies?: boolean, ignoreCase?: boolean): SuggestionCollector;
